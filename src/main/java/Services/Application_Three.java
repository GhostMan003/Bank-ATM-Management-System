...
import Features.CashDeposite;
import Generate_Card_No.CardNumber;
    ...
    public void actionPerformed(ActionEvent ac) {
        if (ac.getSource() == submit) {
            ...
            try {
                ...
                String setquary1 = "SET SQL_SAFE_UPDATES = 0";
                String quary1_del = "DELETE FROM Application_One WHERE From_No =  '"+fromNoString+"')";
                String quary2_del = "DELETE FROM Application_Two WHERE From_No =  '"+fromNoString+"')";
                String setquary2 = "SET SQL_SAFE_UPDATES = 1";
                connectionManager.statement.executeUpdate(setquary1);
                connectionManager.statement.executeUpdate(quary1_del);
                connectionManager.statement.executeUpdate(quary2_del);
                connectionManager.statement.executeUpdate(setquary2);
                setVisible(false);
