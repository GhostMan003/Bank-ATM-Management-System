...
public class MiniStatement extends JFrame{
    ...
    public MiniStatement(String pinNO, String bankString, String cardNO) {
        ...
        try {
            ConnectionManager con = new ConnectionManager();
            ResultSet rs = con.statement.executeQuery("select * from Transaction_Table where Card_Number = '"+cardNO+"' order by DATE DESC limit 3");
            int i = 5;
            while (rs.next() && 0<i) {
